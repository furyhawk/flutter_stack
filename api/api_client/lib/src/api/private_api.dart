...
class PrivateApi {
  ...
  const PrivateApi(this._dio, this._serializers);
  ...
  Future<Response<UserPublic>> privateCreateUser({ 
    required PrivateUserCreate privateUserCreate,
    ...
    final _path = r'/api/v1/private/users/';
    ...
    try {
      const _type = FullType(PrivateUserCreate);
      _bodyData = _serializers.serialize(privateUserCreate, specifiedType: _type);
