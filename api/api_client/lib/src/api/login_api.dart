...
class LoginApi {
  ...
  Future<Response<Token>> loginLoginAccessToken({ 
    ...
    final _path = r'/api/v1/login/access-token';
  ...
  /// Returns a [Future] containing a [Response] with a [Message] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Message>> loginResetPassword({ 
    ...
    final _path = r'/api/v1/reset-password/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(NewPassword);
      _bodyData = _serializers.serialize(newPassword, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserPublic>> loginTestToken({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/login/test-token';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
