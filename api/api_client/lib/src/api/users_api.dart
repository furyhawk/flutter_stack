...
class UsersApi {
  ...
  Future<Response<UserPublic>> usersCreateUser({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Message>> usersDeleteUser({ 
  ...
  /// Returns a [Future] containing a [Response] with a [Message] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Message>> usersDeleteUserMe({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [UserPublic] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserPublic>> usersReadUserById({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [UserPublic] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserPublic>> usersReadUserMe({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UsersPublic] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UsersPublic>> usersReadUsers({ 
    int? skip = 0,
    int? limit = 100,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    UsersPublic? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UsersPublic),
      ) as UsersPublic;
  ...
  /// Returns a [Future] containing a [Response] with a [Message] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Message>> usersUpdatePasswordMe({ 
    ...
    try {
      const _type = FullType(UpdatePassword);
      _bodyData = _serializers.serialize(updatePassword, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [UserPublic] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserPublic>> usersUpdateUser({ 
    required String userId,
  ...
  /// Returns a [Future] containing a [Response] with a [UserPublic] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserPublic>> usersUpdateUserMe({ 
    required UserUpdateMe userUpdateMe,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UserUpdateMe);
      _bodyData = _serializers.serialize(userUpdateMe, specifiedType: _type);
