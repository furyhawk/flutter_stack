...
class UtilsApi {
  ...
  const UtilsApi(this._dio, this._serializers);
  ...
  Future<Response<bool>> utilsHealthCheck({ 
    ...
    final _path = r'/api/v1/utils/health-check/';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Message>> utilsTestEmail({ 
    ...
    final _path = r'/api/v1/utils/test-email/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'email_to': encodeQueryParameter(_serializers, emailTo, const FullType(String)),
    };
